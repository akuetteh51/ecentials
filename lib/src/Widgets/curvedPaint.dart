...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path0.quadraticBezierTo(size.width * 0.0056667, size.height * 0.6864286,
        size.width * 0.0066667, size.height * 0.4200000);
    path0.quadraticBezierTo(size.width * 0.0115000, size.height * 0.1567857,
        size.width * 0.0833333, size.height * 0.0642857);
    path0.quadraticBezierTo(size.width * 0.2587500, size.height * 0.0639286,
        size.width * 0.3416667, size.height * 0.0657143);
    path0.cubicTo(
        size.width * 0.4340000,
        size.height * 0.0017857,
        size.width * 0.3853333,
        size.height * 0.4296429,
        size.width * 0.5016667,
        size.height * 0.4614286);
    path0.cubicTo(
        size.width * 0.5977500,
        size.height * 0.4153571,
        size.width * 0.5682500,
        size.height * 0.0075000,
        size.width * 0.6580000,
        size.height * 0.0600000);
    path0.quadraticBezierTo(size.width * 0.7506667, size.height * 0.0560714,
        size.width * 0.9166667, size.height * 0.0785714);
    path0.quadraticBezierTo(size.width * 0.9973333, size.height * 0.1553571,
        size.width * 0.9953333, size.height * 0.4628571);
    path0.quadraticBezierTo(size.width * 0.9968333, size.height * 0.7328571,
        size.width, size.height * 1.4285714);
