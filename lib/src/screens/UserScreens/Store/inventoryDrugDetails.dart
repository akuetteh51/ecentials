...
class InventoryDrugDetails extends StatefulWidget {
  const InventoryDrugDetails({Key? key}) : super(key: key);

  @override
  State<InventoryDrugDetails> createState() => _InventoryDrugDetailsState();
}

class _InventoryDrugDetailsState extends State<InventoryDrugDetails> {
  final _details = [
    {
      "title": "Condition",
      "subtitle": "Stable",
